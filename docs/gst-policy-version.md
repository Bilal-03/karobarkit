...
The active Milestone 4 bundle is `gst-general-rates-2025-09-22-v1`. It is effective from 22 September 2025 and was last verified on 8 August 2026. It contains only the 5% and 18% headline presets. The absence of a preset is intentional: it prevents an unclassified calculator from turning an official category-specific rate into a general recommendation.
