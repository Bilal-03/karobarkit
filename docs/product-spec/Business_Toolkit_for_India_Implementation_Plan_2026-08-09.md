...
| Tool            | V1 scope and result                                                                      | Important limits                                                                       | Release           |
| --------------- | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- | ----------------- |
| EMI             | Fixed-rate EMI, amortization, total interest, fees, and rate-shock scenarios             | Display rate type and APR/fee limitations                                              | Phase 3           |
...
| Loan Comparison | Compare APR, fees, EMI, total cost, rate type, reset scenario, and prepayment assumption | Do not rank lenders or scrape rates in V1                                              | Phase 3           |
...
| EMI/loan comparison              | Show APR/fees, fixed/floating rate, reset impact, and total cost—not EMI alone                                                                               | [RBI FAQ on floating-rate EMI resets](https://www.rbi.org.in/scripts/FAQView.aspx?Id=170)                                                                                                                        |
