...
export const paymentReceiptDefaultValues: PaymentReceiptInput = {
  ...
  socialHandle: '',
  logo: null,
  footerText: 'Sample receipt — replace with your details.',
  template: 'formal',
  accent: 'teal',
  logoAlignment: 'left',
  headerDivider: true,
  ...
  receivedFrom: 'Sample customer',
  amount: '2500',
  paymentPurpose: 'Sample service payment',
  paymentMethod: 'upi',
  transactionReference: 'DEMO-001',
  paymentNote: 'Sample receipt preview.',
