...
export const letterheadDefaultValues: LetterheadInput = {
  ...
  socialHandle: '',
  logo: null,
  footerText: 'Sample letterhead — replace with your details.',
  template: 'editorial',
  accent: 'teal',
  logoAlignment: 'left',
  headerDivider: true,
  ...
  subject: 'Sample business letter',
  body: 'This is a sample letterhead preview. Replace this text with your own message before exporting.',
