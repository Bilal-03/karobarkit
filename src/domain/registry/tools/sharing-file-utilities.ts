...
export const whatsappLinkTool = createSharingTool<WhatsappInput, WhatsappResult>({
  ...
  defaultValues: { countryCode: '91', phone: '9876543210', message: 'Hello from KarobarKit' },
...
export const vcardQrTool = createSharingTool<VcardInput, VcardResult>({
  ...
  defaultValues: {
    fullName: 'KarobarKit Demo',
    organization: 'KarobarKit',
    phone: '+91 9876543210',
    email: 'hello@example.com',
    website: 'https://example.com',
    address: 'India',
    note: 'Sample contact card',
  },
...
export const wifiQrTool = createSharingTool<WifiInput, WifiResult>({
  ...
  defaultValues: { ssid: 'KarobarKit Demo Wi-Fi', security: 'WPA', password: 'DemoPass123!', hidden: false },
...
export const barcodeGeneratorTool = createSharingTool<BarcodeInput, BarcodeResult>({
  ...
  defaultValues: { symbology: 'code128', value: 'KAROBARKIT-001', showLabel: true, width: 'standard' },
