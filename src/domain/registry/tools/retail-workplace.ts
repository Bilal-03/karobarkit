...
export const priceTagTool = createWorkplaceTool<PriceTagInput, WorkplaceDocument>({
  ...
  defaultValues: {
    businessName: 'KarobarKit Demo Store',
    productName: 'Sample product',
    mrp: '1000',
    offerPrice: '900',
    sku: 'SKU-001',
    barcode: 'KAROBARKIT-001',
...
export const deliveryChallanTool = createWorkplaceTool<DeliveryChallanInput, WorkplaceDocument>({
  ...
  defaultValues: {
    consignor: 'KarobarKit Demo Store\nIndia',
    consignee: 'Sample customer\nIndia',
    itemsText: 'Sample item × 1',
...
export const purchaseOrderTool = createWorkplaceTool<PurchaseOrderInput, WorkplaceDocument>({
  ...
  defaultValues: {
    buyerName: 'KarobarKit Demo Store',
    buyerAddress: 'India',
    supplierName: 'Sample supplier',
    supplierAddress: 'India',
    poNumber: 'PO-001',
    poDate: '2026-08-11',
    items: [{ description: 'Item 1', quantity: '1', unit: 'pcs', unitPrice: '100', taxRate: '0' }],
    taxDisplay: 'none',
    terms: 'Confirm availability and delivery before acceptance.',
    pageProfile: profile('a4'),
    footerText: '',
  },
...
export const menuTool = createWorkplaceTool<MenuInput, WorkplaceDocument>({
  ...
  defaultValues: {
    businessName: 'KarobarKit Demo Café',
    address: 'India',
    phone: '+91 9876543210',
    sections: [{ heading: 'Featured', items: [{ name: 'Sample item', price: '100', note: 'Fresh today' }] }],
    includeQr: false,
    qrUrl: '',
    pageProfile: profile('a4'),
    footerText: 'Sample menu — replace with your details.',
  },
...
export const wageSlipTool = createWorkplaceTool<WageSlipInput, WorkplaceDocument>({
  ...
  defaultValues: {
    employerName: 'KarobarKit Demo Store',
    workerName: 'Sample worker',
    period: 'August 2026',
    grossEarnings: '10000',
    deductions: '0',
    pageProfile: profile('thermal-80'),
    footerText: 'Declared wage slip sample.',
  },
...
export const rentReceiptTool = createWorkplaceTool<RentReceiptInput, WorkplaceDocument>({
  ...
  defaultValues: {
    ...
    date: '2026-08-11',
    pageProfile: profile('a4'),
    footerText: 'Declared rent receipt sample.',
  },
